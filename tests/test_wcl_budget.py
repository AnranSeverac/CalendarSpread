...
from live_execution import (  # noqa: E402
    OpenPosition, _open_positions_wcl, _walk_books, worst_case_loss_per_share,
)
...
def _pos(direction, shares, entry_spread):
    return OpenPosition(
        event_id="e", event_question="q", direction=direction,
